							...
							<ul class="product_list_widget">
								<li>
									<a href="index.php?page=single-product" title="Tablet Thin EliteBook  Revolve 810 G6">
										<img class="wp-post-image" data-echo="{{asset('images/footer/1.jpg')}}" src="{{asset('images/blank.gif')}}" alt="">
								...
								<li>
									<a href="index.php?page=single-product" title="Smartphone 6S 128GB LTE">
										<img class="wp-post-image" data-echo="{{asset('images/footer/2.jpg')}}" src="{{asset('images/blank.gif')}}" alt=""><span class="product-title">Smartphone 6S 128GB LTE</span>
									</a>
								...
								<li>
									<a href="index.php?page=single-product" title="Smartphone 6S 64GB LTE">
										<img class="wp-post-image" data-echo="{{asset('images/footer/3.jpg')}}" src="{{asset('images/blank.gif')}}" alt="">
							...
							<ul class="product_list_widget">
								...
								<li>
									<a href="index.php?page=single-product" title="Tablet Red EliteBook  Revolve 810 G2">
										<img class="wp-post-image" data-echo="{{asset('images/footer/4.jpg')}}" src="{{asset('images/blank.gif')}}" alt="">
								...
								<li>
									<a href="index.php?page=single-product" title="Widescreen 4K SUHD TV">
										<img class="wp-post-image" data-echo="{{asset('images/footer/5.jpg')}}" src="{{asset('images/blank.gif')}}" alt="">
					...
					<aside class="widget clearfix">
						<div class="body">
							...
							<ul class="product_list_widget">
								<li>
									<a href="index.php?page=single-product" title="Notebook Black Spire V Nitro  VN7-591G">
										<img class="wp-post-image" data-echo="{{asset('images/footer/6.jpg')}}" src="{{asset('images/blank.gif')}}" alt="">
										<span class="product-title">Notebook Black Spire V Nitro  VN7-591G</span>
									</a>
								...
								<li>
									<a href="index.php?page=single-product" title="Apple MacBook Pro MF841HN/A 13-inch Laptop">
										<img class="wp-post-image" data-echo="{{asset('images/footer/7.jpg')}}" src="{{asset('images/blank.gif')}}" alt="">
								...
								<li>
									<a href="index.php?page=single-product" title="Tablet White EliteBook Revolve  810 G2">
										<img class="wp-post-image" data-echo="{{asset('images/footer/2.jpg')}}" src="{{asset('images/blank.gif')}}" alt="">
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-7">
					<h5 class="newsletter-title">สมัครสมาชิก</h5>
					<span class="newsletter-marketing-text">เพื่อติดตามรับฟังข่าวสารจากทางเว็บไซต์ </span>
				</div>
					...
					<form>
						<div class="input-group">
							...
							<span class="input-group-btn">
								<button class="btn btn-secondary" type="button">สมัครสมาชิก</button>
							</span>
						</div>
					</form>
				</div>
