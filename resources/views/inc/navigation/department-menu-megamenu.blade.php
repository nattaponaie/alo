                    ...
                    <div class="vc_column-inner ">
                        <div class="wpb_wrapper">
                            <div class="wpb_text_column wpb_content_element ">
                                <div class="wpb_wrapper">
                                    <ul>
                                        <li class="nav-title"><?php echo $categorie["cat_name"] ?></li>
                                        <?php
                                        foreach($sub_categorie_array as $sub_cat_name => $cat_id) {
                                            ?><li><a href="#"><?php echo $sub_cat_name ?></a></li>
                                            <?php
                                        }
                                        ?>
                                        <li class="nav-divider"></li>
                                        <li><a href="#"><span class="nav-text">A.S. Power Tech</span><span class="nav-subtext">ตู้ลำโพงเอี่ยมละออ</span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
