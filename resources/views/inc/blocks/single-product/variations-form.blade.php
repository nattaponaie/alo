<form class="variations_form cart" method="post">
	...
	<div class="single_variation_wrap">
		...
		<div class="woocommerce-variation-add-to-cart variations_button">
			<div class="quantity">
				<label>จำนวน:</label>
				<input type="number" name="quantity" value="1" title="จำนวนสินค้า" class="input-text qty text"/>
			</div>
			<button type="submit" class="single_add_to_cart_button button">หยิบใส่ตะกร้า</button>
