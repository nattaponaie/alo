...
<div class="container">
	...
	<div class="columns-2-1-2">
		<?php
			$productImage = array(
				1 => array('product_image' => '/images/product-2-1-2/1.jpg'),
				2 => array('product_image' => '/images/product-2-1-2/2.jpg'),
				3 => array('product_image' => '/images/product-2-1-2/3.jpg'),
				4 => array('product_image' => '/images/product-2-1-2/4.jpg'),
				);
				...
				<div class="product-outer">
					<div class="product-inner">
						...
						<a href="index.php?page=single-product">
							<h3>Notebook Black Spire V Nitro  VN7-591G</h3>
							<div class="product-thumbnail">
								<img class="wp-post-image" data-echo="{{asset('images/product-2-1-2/main.jpg')}}" src="{{asset('images/blank.gif')}}" alt="">
						...
						<div class="product-inner">
							...
							<a href="index.php?page=single-product">
								...
								<div class="product-thumbnail">
									...
									<img class="wp-post-image" data-echo="<?php echo $productImage[$i]['product_image'] ?>" src="{{asset('images/blank.gif')}}" alt="">
