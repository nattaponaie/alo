<div class="home-v1-ads-block animate-in-view fadeIn animated" data-animation="fadeIn">
	<div class="ads-block row">
		<div class="ad col-xs-12 col-sm-4">
			<div class="media">
				<div class="media-left media-middle">
					<img data-echo="{{asset('images/banner/cameras.jpg')}}" src="{{asset('images/blank.gif')}}" alt="">
				</div>
		...
		<div class="ad col-xs-12 col-sm-4">
			<div class="media">
				<div class="media-left media-middle">
					<img data-echo="{{asset('images/banner/MobileDevicesv2-2.jpg')}}" src="{{asset('images/blank.gif')}}" alt="">
				</div>
				<div class="media-body media-middle">
					<div class="ad-text">
		...
		<div class="ad col-xs-12 col-sm-4">
			<div class="media">
				<div class="media-left media-middle">
					<img data-echo="{{asset('images/banner/DesktopPC.jpg')}}" src="{{asset('images/blank.gif')}}" alt="">
				</div>
				<div class="media-body media-middle">
					<div class="ad-text">
