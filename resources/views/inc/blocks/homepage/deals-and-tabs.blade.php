<div class="home-v1-deals-and-tabs deals-and-tabs row animate-in-view fadeIn animated" data-animation="fadeIn">
	<div class="deals-block col-lg-4">
		<section class="section-onsale-product">
			<header>
				<h2 class="h1">ข้อเสนอสุดพิเศษ</h2>
				<div class="savings">
					<span class="savings-text">ประหยัด <span class="amount">$20.00</span></span>
				</div>
			</header><!-- /header -->
				...
				<div class="onsale-product">
					<a href="index.php?page=shop">
						<div class="product-thumbnail">
							<img class="wp-post-image" data-echo="{{asset('images/onsale-product.jpg')}}" src="{{asset('images/blank.gif')}}" alt=""></div>
					...
					<div class="deal-progress">
						<div class="deal-stock">
							<span class="stock-sold">ขายไปแล้ว: <strong>2</strong></span>
							<span class="stock-available">จำนวนคงเหลือ: <strong>26</strong></span>
						</div>
					...
					<div class="deal-countdown-timer">
						<div class="marketing-text text-xs-center">ซื้อก่อนข้อเสนอนี้จะหมดเวลาใน:	</div>
	...
	<div class="tabs-block col-lg-8">
		<div class="products-carousel-tabs">
			<ul class="nav nav-inline">
				<li class="nav-item"><a class="nav-link active" href="#tab-products-1" data-toggle="tab">แนะนำ</a></li>
				<li class="nav-item"><a class="nav-link" href="#tab-products-2" data-toggle="tab">ลดราคา</a></li>
				<li class="nav-item"><a class="nav-link" href="#tab-products-3" data-toggle="tab">ชื่นชอบ</a></li>
			</ul>
				...
				<div class="tab-pane" id="tab-products-2" role="tabpanel">
					<div class="woocommerce columns-3">
						<?php
                            $column = 3;
							$productImage = array(
								1 => array('product_image' => '/images/products/6.jpg'),
								2 => array('product_image' => '/images/products/5.jpg'),
								3 => array('product_image' => '/images/products/4.jpg'),
								4 => array('product_image' => '/images/products/3.jpg'),
								5 => array('product_image' => '/images/products/2.jpg'),
								6 => array('product_image' => '/images/products/1.jpg'),
								7 => array('product_image' => '/images/products/3.jpg')
								);
									...
									<div class="product-inner">
										...
										<a href="index.php?page=single-product">
											...
											<div class="product-thumbnail">
												...
												<img data-echo="<?php echo $productImage[$i]['product_image'] ?>" src="{{asset('images/blank.gif')}}" alt="">
