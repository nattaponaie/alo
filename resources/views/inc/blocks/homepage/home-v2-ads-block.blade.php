<div class="home-v2-ads-block animate-in-view fadeIn animated" data-animation=" animated fadeIn">
    <div class="ads-block row">
        <div class="ad col-xs-12 col-sm-6">
            <div class="media">
                <div class="media-left media-middle"><img src="{{asset('images/ad-block/1.jpg')}}" alt="" /></div>
        ...
        <div class="ad col-xs-12 col-sm-6">
            <div class="media">
                <div class="media-left media-middle"><img src="{{asset('images/ad-block/2.jpg')}}" alt="" /></div>
                <div class="media-body media-middle">
                    <div class="ad-text">
